            ...
            <div className="flex items-center gap-6">
              {!session ? (
                ...
                >
                  ...
                  <span className="relative flex items-center gap-2">
                    Volver al Juego <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
                  </span>
                </button>
              )}
            </div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              {!session ? (
                ...
                <button
                  onClick={() => router.push('/dashboard')}
                  className="w-full sm:w-auto group relative px-8 py-4 text-base font-semibold text-white bg-white/10 hover:bg-white/20 rounded-full overflow-hidden transition-all duration-300 ease-out border border-white/10 shadow-[0_0_40px_-10px_rgba(34,214,94,0.3)] hover:shadow-[0_0_60px_-15px_rgba(34,214,94,0.5)]"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-emerald-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <span className="relative flex items-center justify-center gap-2">
                    Volver al Juego <ChevronRight size={18} className="group-hover:translate-x-1 transition-transform" />
                  </span>
                </button>
              )}
