            ...
            {links.map((link) => (
              <Link
                ...
                className={`flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-medium transition-all ${
                  link.disabled
                    ? 'text-[#3c3c60] cursor-not-allowed opacity-50'
                    : pathname === link.href
                    ? 'glass text-[#818cf8]'
        ...
        <div className="flex items-center gap-4">
          ...
          {closedTrades.length > 0 && (
            <div className="hidden lg:flex items-center gap-1.5 glass rounded-xl px-3 py-1.5">
              ...
              <span className={`text-xs font-bold ${winRate >= 50 ? 'text-[#22d65e]' : 'text-[#ef4466]'}`}>
                {winRate}%
              </span>
            </div>
          )}
          ...
          {/* User Profile */}
          <div className="hidden sm:flex items-center gap-2 glass rounded-xl pl-1.5 pr-2.5 py-1">
            {profile?.avatar_url ? (
